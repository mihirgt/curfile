...
/**
 * Configuration class for the CUR Ingestion application.
...
public class AppConfig {
    ...
    public String getProjectId() {
        ...
        if (value == null) {
            ...
            if (value == null) {
                @SuppressWarnings("unchecked")
                Map<String, Object> gcpConfig = config != null ? (Map<String, Object>) config.get("gcp") : null;
                if (gcpConfig != null) {
                    @SuppressWarnings("unchecked")
    ...
    public String getGcsBucket() {
        ...
        if (value == null) {
            @SuppressWarnings("unchecked")
            Map<String, Object> gcsConfig = config != null ? (Map<String, Object>) config.get("gcs") : null;
    ...
    public String getCurFilePath() {
        ...
        if (value == null) {
            @SuppressWarnings("unchecked")
            Map<String, Object> curConfig = config != null ? (Map<String, Object>) config.get("cur") : null;
            if (curConfig != null) {
                @SuppressWarnings("unchecked")
    ...
    public String getTemporaryBucket() {
        ...
        if (value == null) {
            @SuppressWarnings("unchecked")
            Map<String, Object> bqConfig = config != null ? (Map<String, Object>) config.get("bigquery") : null;
            if (bqConfig != null) {
                @SuppressWarnings("unchecked")
