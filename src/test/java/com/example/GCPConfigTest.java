...
public class GCPConfigTest {
    ...
    public void testLoadConfiguration() throws IOException {
        ...
        assertThat(config.getProperty("gcp.service.account.key", "")).isEqualTo("/path/to/test-key.json");
    }
    ...
    public void testConfigureSparkForGCP() throws IOException {
        ...
        assertThat(sparkConf.get("temporaryGcsBucket"))
            .isEqualTo(TEST_TEMP_BUCKET);
    }
